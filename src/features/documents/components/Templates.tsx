            ...
            templates.map((template) => (
              ...
              >
                <div className='group cursor-pointer'>
                  <div className='relative h-72 bg-white dark:bg-gray-800 border-2 border-gray-200 dark:border-gray-700 rounded-xl shadow-md hover:shadow-xl transition-all duration-300 hover:-translate-y-1 overflow-hidden'>
                    {/* Template preview */}
